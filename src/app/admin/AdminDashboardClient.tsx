      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-orange-600">{unfulfilledOrders}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-sm font-medium text-gray-600 mb-2">Low Stock Products</h3>
            <p className="text-2xl sm:text-3xl font-bold text-orange-600">{lowStockProducts}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          >
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Products</h3>
            <p className="text-xs sm:text-sm text-gray-600">Manage products and stock levels</p>
          </Link>
          <Link
            href="/admin/offers"
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:border-blue-500 hover:shadow-md active:bg-gray-50 transition-all block min-h-[44px]"
          >
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Offers</h3>
            <p className="text-xs sm:text-sm text-gray-600">Create and manage special offers</p>
          </Link>
          <Link
            href="/admin/orders"
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:border-blue-500 hover:shadow-md active:bg-gray-50 transition-all block min-h-[44px]"
          >
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Orders</h3>
            <p className="text-xs sm:text-sm text-gray-600">View and manage orders</p>
          </Link>
          <Link
            href="/admin/reports"
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:border-blue-500 hover:shadow-md active:bg-gray-50 transition-all block min-h-[44px]"
          >
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Reports</h3>
            <p className="text-xs sm:text-sm text-gray-600">View sales and order statistics</p>
          </Link>
          <Link
            href="/admin/settings"
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:border-blue-500 hover:shadow-md active:bg-gray-50 transition-all block min-h-[44px]"
          >
            ...
            <p className="text-xs sm:text-sm text-gray-600">Change end user password</p>
          </Link>
        </div>
                ...
                {recentOrders.map((order) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                      <div>
                        <p className="font-medium text-gray-900 text-sm sm:text-base">{order.username}</p>
